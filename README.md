...
<manifest..>
    ...
    <!-- Optional permissions. The following permissions are required only if you want to implement push notifications using GCM. Replace <i><Your package name></i> with your application's package name -->
    <permission
